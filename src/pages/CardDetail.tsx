    ...
    <div className="space-y-6 pb-24 lg:pb-8">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="w-full lg:w-1/3 space-y-6">
          ...
          {/* Actions - Desktop (Hidden on mobile, shown on lg) */}
          <div className="hidden lg:flex flex-col gap-3">
            ...
            {isActive && card.filledSlots > 0 && (
              <button
                ...
                className="w-full py-3 bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-500 rounded-xl font-semibold text-sm hover:bg-amber-100 dark:hover:bg-amber-900/40 transition-all flex items-center justify-center border border-amber-200 dark:border-amber-800/50"
              >
            ...
            {(isActive || isCompleted) && card.filledSlots > 0 && (
              <button
                ...
                className="w-full py-3 bg-slate-50 dark:bg-slate-700 text-red-500 dark:text-red-400 rounded-xl font-semibold text-sm hover:bg-slate-100 dark:hover:bg-slate-600 transition-all flex items-center justify-center border border-slate-200 dark:border-slate-600"
              >
        ...
        <div className="w-full lg:w-2/3 space-y-6">
          <div className="px-1 lg:px-0">
            ...
            <div className="bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm h-56 overflow-x-auto overflow-y-hidden custom-scrollbar" style={{ touchAction: 'pan-y' }}>
      ...
      {/* Actions - Mobile (Hidden on lg) */}
      <div className="lg:hidden fixed bottom-16 left-0 right-0 p-4 bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 z-20 max-w-md mx-auto transition-colors duration-200 md:relative md:bottom-auto md:p-0 md:bg-transparent md:dark:bg-transparent md:border-none md:max-w-none md:mt-6 md:flex md:gap-4 md:flex-wrap">
        {isActive && (
          <button
            onClick={handleAddInstallment}
